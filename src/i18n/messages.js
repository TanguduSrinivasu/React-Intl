...
click_here: "click here",
  ...
  [LOCALES.FRENCH]: {
    logo: "Réagir international",
    learn_to: "Bonjour, apprenons à utiliser React-Intl",
    price_display:
      "Comment {n, number, ::currency/EUR} $ s'affiche dans la langue sélectionnée",
    number_display:
...
click_here: "Cliquez ici",
  ...
  [LOCALES.GERMAN]: {
    ...
    price_display:
      "Wie {n, number, ::currency/EUR} in Ihrer ausgewählten Sprache angezeigt wird",
    number_display:
  ...
  [LOCALES.JAPANESE]: {
    ...
    price_display:
      "選択した言語で{n, number, ::currency/JPY}がどのように表示されるか",
    number_display:
